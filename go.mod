...
module example.com/hello // This is the name of the module. It usually reffers to the UTL where the module can be downloaded. We need the '.' in the name for compatibility with go tools.
